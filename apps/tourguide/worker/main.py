...
from .handler import TourNexusServiceHandler


async def main():
    temporal_address = os.getenv("TEMPORAL_ADDRESS", "localhost:7233")
    temporal_namespace = os.getenv("TEMPORAL_NAMESPACE", "tourguide")
    ...
    worker = Worker(
        client,
        task_queue="tourguide-task-queue",
        workflows=[RunTourPlanWorkflow],
